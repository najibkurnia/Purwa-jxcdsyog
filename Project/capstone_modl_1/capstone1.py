...
def menu_read():
    while True:
        try:
            ...
            pilihan = int(input("Pilih menu (1-3s): "))
            ...
            if pilihan == 1:
                ...
                print("Pilihan tidak valid. Silakan pilih lagi.Silahkan masukan kembali angka antara 1,2,3,4,5")
...
def hapus_pemain():
    while True:
        ...
        print(f"Pemain {nama} telah dihapus.")
